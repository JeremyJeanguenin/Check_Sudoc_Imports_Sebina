...
Dans le cadre d'un import quotidien de notices du Sudoc via une passerelle (get_title_data) vers le SIGB Sebina, ce script permet de traiter plus rapidement un grand nombre de rapports.
