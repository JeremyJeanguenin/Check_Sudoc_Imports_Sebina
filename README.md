...
Script permettant d'analyser les alertes (WARN) de type doublon exemplaire (cause manque PPN dans le SIGB : la correspondance déclenche la mise à jour de la notice) > # Détection uniquement des warnings "Code-barres déjà présent"
